...
- `walicord-core`: The core logic of the application. It contains the application services, domain model, and infrastructure for parsing and processing the walicord language.
...
- `walicord-interpreter`: A command-line tool for running `.walicord` scripts.