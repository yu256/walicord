...
impl VoidSurfaceModel {
    pub fn selection(
        ...
        Self {
            ...
            phase_copy: vec![i18n::void_selection_window_guidance().to_owned()],
    ...
    pub fn missing_selection(
        ...
        Self {
            ...
            snapshot_notice: None,
            phase_copy: vec![
                i18n::void_missing_selection_error().to_owned(),
                i18n::void_selection_window_guidance().to_owned(),
            ],
            warning_lines: Vec::new(),
            recovery_cta: RecoveryCta::None,
            recovery_url: None,
    ...
    pub fn stale_target(
        ...
        Self {
            ...
            snapshot_notice: None,
            phase_copy: vec![
                i18n::void_stale_target_error(reason_text).to_string(),
                i18n::void_selection_window_guidance().to_owned(),
            ],
            warning_lines: Vec::new(),
            recovery_cta: RecoveryCta::None,
